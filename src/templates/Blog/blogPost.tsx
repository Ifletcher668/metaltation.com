...
export interface Props {
    data: {[key: string]: {[key: string]: StrapiBlog}}
    location: Location
}
...
export default ({data, location}: Props) => {
    ...
    const coverImage = cover_image.media[0]
        ...
        <Layout location={location}>
            ...
            <section className="grid band">
                <div className="information">
                    <Title level={4}>{band_information.band_name}</Title>
                    {band_information.band_bio}
                </div>
                {band_information.social_media && (
                    <div className="grid social-media">
                        <div className="row">
                            <a
                                href={band_information.social_media.facebook}
                                target="_blank"
                            >
                                <FaFacebook />
                                <Title level={6}>
                        ...
                        <div className="row">
                            <a
                                href={band_information.social_media.instagram}
                                target="_blank"
                            >
                                <FaInstagram />
                                <Title level={6}>
                        ...
                        <div className="row">
                            <a
                                href={band_information.social_media.twitter}
                                target="_blank"
                            >
                                <FaTwitter />
                                <Title level={6}>
                        ...
                        <div className="row">
                            <a
                                href={band_information.social_media.youtube}
                                target="_blank"
                            >
                                <FaYoutube />
                                <Title level={6}>
                        ...
                        <div className="row">
                            <a
                                href={band_information.social_media.website}
                                target="_blank"
                            >
                                <FaWifi />
                                <Title level={6}>
