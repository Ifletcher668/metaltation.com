        ...
        <Layout location={props.location}>
            ...
            <Row gutter={36} className="posts">
                <Col
                    ...
                    xxl={18}
                    id="primary"
                    className="content-area with-sidebar"
                >
                ...
                >
                    <Twitter
                        title={<h3 className="margin-bottom-36px">Twitter</h3>}
                    />
                    <Facebook
                        title={
                            <h3 className="margin-top-36px margin-bottom-36px">
                                Facebook
                            </h3>
                        }
                    />
                    <Instagram
                        allInstaNode={props.pathContext.allInstaNode}
            ...
            <Row type="flex" align="middle" gutter={36}>
                <Col
                    ...
                    xl={0}
                    xxl={0}
                    className="align-center margin-top-36px margin-bottom-36px"
                >
                    <Instagram
                        allInstaNode={props.pathContext.allInstaNode}
